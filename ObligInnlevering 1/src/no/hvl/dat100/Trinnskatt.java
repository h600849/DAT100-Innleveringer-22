...
public class Trinnskatt {
	...
	public static void main(String[] args) {
		...
		if (bruttoInntekt <= 267900) { 
			...
			showMessageDialog(null, "Du er på skattetrin 3, du betaler " + bruttoInntekt* trinn3 + " kr i skatt");
		}
		
		else if (bruttoInntekt >=969200 && bruttoInntekt < 2000000) {
			showMessageDialog(null, "Du er på skattetrin 4, du betaler " + bruttoInntekt* trinn4 + " kr i skatt");
		}
		
		else if (bruttoInntekt >=2000000) {
			showMessageDialog(null, "Du er på skattetrin 5, du betaler " + bruttoInntekt* trinn5 + " kr i skatt");
		}
